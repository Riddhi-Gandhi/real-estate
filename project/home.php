...
<div class="home">
   ...
   <section class="center">
      <form style="background-color: var(--white);" action="search.php" method="post">
         ...
         <div class="flex">
               ...
               <div class="box">
                  <p>Available from date <span>*</span></p>
                  <input type="date" name="h_available_date" class="input" required>
               </div>
               <div class="box">
...
<script>
    // JavaScript to update the selected price range value
    const priceRangeInput = document.querySelector('input[name="h_price_range"]');
